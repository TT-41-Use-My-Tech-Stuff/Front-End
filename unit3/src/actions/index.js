...
// // axiosWithAuth()
//     // .get(`/devices/${id}`)
//     .get ('localhost:666/api/items', {}, (res, err))
//     .then((res) => {
...
// /**** ACTIONS FOR GET ****/
// export const FETCH_DEVICEID_FAILURE = "FETCH_DEVICEID_FAILURE";
// export  FETCH_DEVICEID_SUCCESS = "FETCH_DEVICEID_SUCCESS";
...
// export const requestSignIn = (userData) => (dispatch) => {
//   dispatch({ type: IS_FETCHING });
//   axiosWithAuth()
...
//     });
// };
// export  IS_FETCHING = "IS_FETCHING";

axios
    .get(localhost:666/api/items)
